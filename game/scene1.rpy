label start: 
    ...
    nth "Can’t even remember how I got here…"
    ...
    nth "Where the hell {i}is{/i} here!?"
    nth "This isn’t my room!"
    ...
    nth "Drunk Natalie I owe you my {i}life.{/i}"
    ...
    # Expression change to nat_n_s
    nth "Huh, these are really nice too."
    # Expression change to nat_h_b
    nth "Heh, looks like I finally landed that sugar mama!"
    ...
    # Expression change to nat_n
    nth "Doesn’t {i}feel{/i} like I’ve had sex though…"
    nrt "Do you even remember what that feels like?"
    # Expression change to nat_sa
    nth "Well, yeah it {i}has{/i} been a while since uni… But not {i}that{/i} long, right?"
    ...
    # Expression change to nat_n
    nth "I dunno, I guess I must’ve got drunk as shit."
    nrt "Starting with the obvious, we’ll make a detective of you yet."
    # Expression change to nat_n_sideeye
    nth "And… I guess, maybe, I was too drunk to get myself home?"
    # Expression change to nat_n_s
    nth "So maybe it {i}wasn’t{/i} a stranger!"
    # Expression change to nat_h
    nth "One of the people I was out with must’ve let me stay at their place, right?"
    # Expression change to nat_n_s
    nth "Yeah that makes sense. Ciara used to talk about crashing on people’s sofas all the time after house parties or socials or whatever."
    # Expression change to nat_n
    nth "Never really felt like my scene but, here I am I guess."
    # Expression change to nat_n_s
    nth "Explains the banana and the water too."
    ...
    nth "Oh god I probably threw up didn’t I."
    nth "Shit, I really hope I didn’t get any on them."
    # Expression change to nat_sa
    nth "As if this couldn’t get any more embarrassing."
    ...
    # Lillian appears, insert l_n_s_sp
    show l_n_s_sp 
    ...
    hide l_n_s_sp
    show l_n_s
    nat "You’re literally an angel, you know that."
    # Expression change to nat_sa_sp
    nat "Seriously, I’m so sorry I got so drunk. I dunno what the hell happened, I usually know my limits better than that."
    # Expression change to l_n_s_sp
    hide l_n_s
    show l_n_s_sp
    ...
    nat "…Feeling like shit, I gotta be honest."
    # Expression change to nat_sy_sp
    nat "Not your fault! I’d probably be dead if not for that water."
    # Expression change to l_h_sp
    hide l_sy
    show l_h_sp
    lil "Then I’m glad to have assisted!"
    # Expression change to l_sy_sp
    hide l_h_sp
    show l_sy_sp
    ...
    # Expression change to nat_n_s
    nth "Well she {i}was{/i} studying pharma, makes sense."
    ...
    # Expression change to nat_shy_b
    nth "No! She’s just… Really good at this, OK?"
    nrt "The lady doth protest too much."
    # Expression change to nat_n
    nth "I should probably answer her question anyway…"
    # Expression change to nat_sa_sp
    nat "Mostly my head, yeah."
    nat "My mouth tastes all metallic too, and the rest of my body’s pretty sluggish."
    # Expression change to nat_n_sp
    nat "Banana helped a bit with the taste, but it’s not entirely going away."
    # Expression change to l_sy_sp
    hide l_sy
    show l_sy_sp
    lil "I can grab you some more food if you’d like? Would another banana be too much, or—"
    # Expression change to nat_sy_sp
    nat "It’s fine! You’ve already done so much to help, I don’t wanna be any more of an imposition than I already have been."
    # Expression change to l_n_s_sp
    hide l_sy_sp
    show l_n_s_sp
    ...
    # Expression change to nat_sy_sp
    nat "Thanks. Seriously, I mean it."
    # Expression change to nat_n_sideeye_sp
    nat "It’s… Not common for…"
    nrt "You take a quick breath, trying to shake your head, then regretting the horrible pain that causes."
    # Expression change to nat_sa_sp
    nat "No one really looks after me much, so this really means a lot to me Lillian, thanks."
    ...
    show l_sa
    # Expression change to nat_ap_sp
    nat "Was I {i}that{/i} much of a mess last night?"
    # Expression change to l_sa_sp
    hide l_sa
    show l_sa_sp
    ...
    nrt "Or lack of one."
    # Expression change to nat_n_sideeye
    nth "Shit, I probably actually said that."
    # Expression change to nat_sa_sp
    nat "Oh {i}god{/i} I’m so sorry, I hope I didn’t ruin the mood."
    # Expression change to l_sy_sp
    hide l_sa
    show l_sy_sp
    ...
    show l_ag
    # Expression change to nat_sa_sp
    nat "Shit Lillian, I’m sorry I {i}really{/i} didn’t mean to go into all that last night. I was just, I dunno, I thought we’d just be catching up."
    # Expression change to l_n_sp
    hide l_ag
    show l_n_sp
    ...
    nat "O-Oh! That’s— That’s really sweet of you Lillian!"
    # Expression change to nat_h_b_sp
    nat "Gotta be the number one experience I’ve had waking up with a hangover too, haha!"
    # Expression change to l_h_sp_b
    hide l_h_b
    show l_h_sp_b
    lil "Haha!"
    ...
    # Expression change to nat_ap_sp
    nat "Anyway, thanks so much for all this, but I really gotta get ready for work now. I’m probably already late…"
    # Expression change to l_h_sp
    hide l_h_b
    show l_h_sp
    ...
    nat "What!?"
    # Expression change to nat_sa_sp
    nat "Lillian, I can’t just take the day off for a hangover. And there’s no way they’d accept that as an excuse for a sick day either."
    # Expression change to l_n_sp
    hide l_h
    show l_n_sp
    ...
    hide l_n_sp
    show l_n
    nat "Seriously? You’ve already done so much."
    # Expression change to l_h_sp
    hide l_n
    show l_n_sp
    ...
    # Expression change to nat_n
    nth "Bacon and eggs is white as {i}hell.{/i}"
    ...
    # Expression change to nat_n_sideeye
    nth "May as well paint {i}adoptive white parents{/i} on my face."
    # Expression change to nat_n_sideeye_sp
    nat "Um…"
    ...
    nat "Not like I can do much else, haha."
    # Expression change to nat_n_sideeye_sp
    nat "And I promise not to throw this up like I did whatever I had for dinner last night."
    # Expression change to nat_sa_sp
    nat "Actually shit I’m {i}so{/i} sorry if I got any on you."
    # Expression change to l_n_sp
    hide l_ap
    show l_n_sp
    lil "Hm?"
    ...
    nat "Oh."
    # Expression change to nat_ap_sp
    nat "Well, spared {i}that{/i} embarrassment at least. Thanks for the reassurance."
    # Expression change to l_sy_sp
    hide l_sy
    show l_sy_sp
    lil "Any time, Nat."
