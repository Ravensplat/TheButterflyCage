label scene4:
    ...
    # nat_neutral_sideeye
    nth "(I didn’t have that much to drink…)"

    nrt "No, you didn’t."
    # nat_neutral_sideeye
    nth "(I never have that much to drink anyway. I do know my limits…)"

    nrt "Yes, you do."
    # nat_sad
    nth "(And I’ve never been drunk enough to wake up in anyone else’s bed with no memory of how I got there…)"

    nrt "No, you haven’t."
    # nat_neutral_sideeye
    nth "(…)"
    # nat_neutral
    nth "(It was… pretty weird that Lillian messaged my work for me, wasn’t it?)"
    # nat_sad
    nth "(And then didn’t give me my phone back all day…)"

    nrt "You thought so even at the time, but didn’t press the matter too much."
    # nat_neutral_sideeye
    nth "(…)"
    # nat_sad
    nth "(And she keeps talking about me being here… like I’m gonna be here forever.)"

    nrt "Like she knew this was going to happen all along."
    # nat_sad_eyesclosed
    nth "(I… don’t wanna finish this thought…)"

    nrt "But you have to."
    # nat_sad_eyesclosed
    nth "(…)"
    # nat_sad
    nth "(Why did that water Lillian gave me… taste so weird…)"
    ...
    nth "(Shit. Shit!)"
    # nat_dejected_smile
    nth "(No. I must be panicking. Lillian wouldn’t… That’s crazy why would I ever think that.)"
    # nat_shy_blush
    nth "(She’s been so nice to me, and listened to me, and held me when I cried, and—)"

    nrt "Enjoyed the fact that you’ve been entirely dependent on her?"
    # nat_angry
    nth "(No!)"
    # nat_sad
    nth "(That’s not… She wouldn’t…?)"
    ...
    # nat_sad
    nth "(That’s ridiculous! I…)"

    nrt "When was the last time you spoke to your family, Natalie?"
    # nat_dejected_smile
    nth "(Um… Does the groupchat count?)"

    nrt "You think sending cry-laughing emoji reactions every few weeks to jokes you don’t even find funny counts? "
    # nat_angry
    nth "(That’s not the point! I don’t need them to come rescue me, I don’t need rescuing!)"
    # nat_dejected_smile
    nth "(I’m just being paranoid. Lillian’s been so lovely to me all day, and yesterday. All I’ve done is complain about my shitty life.)"
    ...
    # nat_annoyed
    nth "(No, because Lillian hasn’t kidnapped me! That’s insane!)"
    # nat_apologetic
    nth "(Honestly, I owe her an apology for even acknowledging that.)"

    # Shower SFX stops
    # nat_sympathetic
    nth "(Perfect timing. I’m gonna go talk to her now, clear everything up, and then apologise for even thinking such ridiculous shit.)"
    # nat_sympathetic
    nth "(When she’s been so nice to me all day, too!)"
    ...
    # nat_dejected_smile
    nth "(No. I’m thinking about how I’m gonna apologise to her once I open this do—)"
    ...
    # nat_surprised
    nth "(I’m sure there’s… a perfectly normal… explanation…?)"

    nrt "Since when is being drugged and kidnapped and held in a locked room perfectly normal?!"
    # nat_surprised
    nth "(The windows?)"
    # nat_neutral_sideeye
    nth "(They’re… pretty high off the ground aren’t they?)"
    ...
    nat "Oh. Uh. Yeah I— Um. Wanted to stretch my legs a bit. Y’know. Lying in bed all day haha."
    ...
    nth "(Well if she’s so dangerous, it’s not like I should be taking my eyes off her…)"

    nrt "You’re staring at her tits!"
    # nat_surprised_blush
    nth "(They’re at eye height!)"
    # lil_neutral_smile
    ...
    # nat_sympathetic_speaking
    nat "No it’s… Fine. Great. Um… Yeah, mi casa es tu casa except with bed I can’t remember the Spanish word for bed I haven’t spoken it since Year 9 sorry."
    # lil_happy_blush
